/*  Airport Simulator Application MAIN file

    @authors Vincenzo Crisà - Stefano D'Urso - Fabrizio Italia

    This file is the main file for the Airport simulator application. It
    loads the necessary files and starts the application.

    The application is a simple airport simulator that is controlled by
    an INDIGOLOG program.
*/
